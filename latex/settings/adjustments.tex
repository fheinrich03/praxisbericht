...
% Setze den Seitenstil für Kapitelanfangsseiten
\let\origchapter\chapter
\renewcommand\chapter[2][\@empty]{%
    \cleardoublepage
    \ifx\@empty#1\origchapter{#2}\else\origchapter[#1]{#2}\fi
    \thispagestyle{chapterstart}% Setze den Seitenstil für die erste Seite des Kapitels
}
